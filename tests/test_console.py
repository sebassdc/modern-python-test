"""Module to test the console module."""
...
def main_invokes_requests_get(runner: CliRunner, mock_requests_get: Mock) -> None:
    """It invokes requests.get."""
    runner.invoke(console.main)
    assert mock_requests_get.called


def main_uses_en_wikipedia_org(runner: CliRunner, mock_requests_get: Mock) -> None:
